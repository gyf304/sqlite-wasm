...
export interface SQLiteExports extends WebAssembly.Exports {
	...
	sqlite3_is_interrupted: (a: CPointer) => CInteger;
	...
	sqlite3_uri_parameter: (z: unknown, zParam: CString) => CString;
	sqlite3_uri_boolean: (z: unknown, zParam: CString, bDefault: CInteger) => CInteger;
	sqlite3_uri_int64: (a: unknown, b: CString, c: CInteger64) => CInteger64;
	sqlite3_uri_key: (z: unknown, N: CInteger) => CString;
	sqlite3_filename_database: (a: unknown) => CString;
	sqlite3_filename_journal: (a: unknown) => CString;
	sqlite3_filename_wal: (a: unknown) => CString;
	sqlite3_database_file_object: (a: CString) => CPointer;
	sqlite3_create_filename: (zDatabase: CString, zJournal: CString, zWal: CString, nParam: CInteger, e: CPointer) => unknown;
	sqlite3_free_filename: (a: unknown) => void;
	...
	sqlite3_error_offset: (db: CPointer) => CInteger;
	...
	sqlite3_stmt_explain: (pStmt: CPointer, eMode: CInteger) => CInteger;
	...
	sqlite3_value_encoding: (a: CPointer) => CInteger;
	...
	sqlite3_get_clientdata: (a: CPointer, b: CString) => CPointer;
	sqlite3_set_clientdata: (a: CPointer, b: CString, c: CPointer, d: CFunctionPointer) => CInteger;
	...
	sqlite3_db_name: (db: CPointer, N: CInteger) => CString;
	sqlite3_db_filename: (db: CPointer, zDbName: CString) => unknown;
	...
	sqlite3_vtab_collation: (a: CPointer, b: CInteger) => CString;
	sqlite3_vtab_distinct: (a: CPointer) => CInteger;
	sqlite3_vtab_in: (a: CPointer, iCons: CInteger, bHandle: CInteger) => CInteger;
	sqlite3_vtab_in_first: (pVal: CPointer, b: CPointer) => CInteger;
	sqlite3_vtab_in_next: (pVal: CPointer, b: CPointer) => CInteger;
	sqlite3_vtab_rhs_value: (a: CPointer, b: CInteger, c: CPointer) => CInteger;
	sqlite3_stmt_scanstatus: (pStmt: CPointer, idx: CInteger, iScanStatusOp: CInteger, pOut: CPointer) => CInteger;
	sqlite3_stmt_scanstatus_v2: (pStmt: CPointer, idx: CInteger, iScanStatusOp: CInteger, flags: CInteger, pOut: CPointer) => CInteger;
	...
	sqlite3changeset_upgrade: (db: CPointer, zDb: CString, nIn: CInteger, pIn: CPointer, pnOut: CPointer, f: CPointer) => CInteger;
	sqlite3changegroup_new: (a: CPointer) => CInteger;
	sqlite3changegroup_schema: (a: CPointer, b: CPointer, zDb: CString) => CInteger;
